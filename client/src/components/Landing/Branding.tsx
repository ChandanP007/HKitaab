  ...
  return (
    <main>
      ...
      <section className=" sm:my-20 flex flex-col items-center sm:bg-gray-100 p-5">
        <h1 className="text-2xl sm:text-4xl font-bold text-center p-5 sm:p-12">
          Why choose HisaabKitaab?
        </h1>
        <div className="flex flex-wrap justify-center gap-1 sm:gap-32 mt-5 w-[100vw]">
          <div className="flex flex-col gap-5 justify-center items-center border-[1px] p-1 sm:border-none sm:p-0">
            <MdOutlineAccountTree className="text-8xl sm:text-9xl text-center" />
            <h2
              className="
            text-2xl bg-black
          ...
          <div className="flex flex-col gap-5 justify-center items-center border-[1px] p-1 sm:border-none sm:p-0">
            <MdQueryStats className="text-8xl sm:text-9xl text-center" />
          ...
          <div className="flex flex-col gap-5 justify-center items-center border-[1px] p-1 sm:border-none sm:p-0">
            <GoShieldCheck className="text-8xl sm:text-9xl text-center" />
            <h2 className="text-2xl bg-black text-white p-2 w-[49px] text-center rounded-full">
              3
            </h2>
            <p className="font-semibold w-[170px] sm:w-[200px] text-center text-sm sm:text-md">
          ...
          <div className="flex flex-col gap-5 justify-center items-center border-[1px] p-1 sm:border-none sm:p-0">
            <PiNewspaperLight className="text-8xl sm:text-9xl text-center" />
            <h2 className="text-2xl bg-black text-white p-2 w-[49px] text-center rounded-full">
              4
            </h2>
            <p className="font-semibold w-[170px] sm:w-[200px] text-center text-sm sm:text-md">
      ...
      <section className="sm:flex sm:m-32 justify-around items-center">
        ...
        <section>
          <h1 className="text-4xl p-2 mt-10 sm:p-0 sm:mt-0 sm:text-5xl font-bold  ">
            Empower <br></br>Your Business <br></br> with <br className="hidden sm:block"></br>Cutting-Edge
            Technology
          </h1>
        </section>
        <img
