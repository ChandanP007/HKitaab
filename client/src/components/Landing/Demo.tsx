...
export default function Demo() {
  ...
  return (
    <>
      <main className="sm:flex justify-center xl:max-2xl:justify-between p-5 h-[80vh] items-center bg-gray-900 text-white">
        <section className="flex gap-10 flex-col w-[40vw]" data-aos="fade-up">
          <h1 className="p-2  text-white text-md font-thin">HisaabKitaab.io</h1>
          <h2 className="text-6xl font-thin  p-3">
            Here Are 4 Simple Steps <br />
            to Make a Transaction and <br /> Upload Your Ledger
          </h2>

          <ul className="list-disc px-12 text-lg font-thin ">
        ...
        <section className="" data-aos="zoom-in ">
          ...
          >
            ...
            <button
              ...
              className="absolute top-1/2 left-4 transform -translate-y-1/2 bg-gray-800 text-white p-3 w-12 rounded-full"
            >
              &#10094;
            </button>
            <button
              onClick={() => setCurrent((prev) => (prev + 1) % images.length)}
              className="absolute top-1/2 right-4 transform -translate-y-1/2 bg-gray-800 text-white p-3 w-12 rounded-full"
            >
              &#10095;
            </button>
          </div>
