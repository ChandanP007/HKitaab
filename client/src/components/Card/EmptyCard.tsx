...
const EmptyCard = () => {
  ...
  return (
    <>
      <div
        className={`flex flex-col border-2 hover:shadow-md w-[225px] h-[250px] items-center justify-center cursor-pointer ${bgDrop}`}
        onClick={() => {
          setAddBusinessModal(true); setDialogOpen(true)
        }}
      >
        <FaPlus className="text-5xl text-black/70" />
        <button className="font-thin p-5">Add</button>
      </div>
