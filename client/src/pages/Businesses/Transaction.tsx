  ...
  return (
    <>
      <main className="flex justify-center">
        <div className="p-3 w-[50vw] h-[100vh] bg-gray-50 border-dotted border-4 shadow-">
          {/* Top section  */}
          ...
          {transactionData && (
            <>
              <h1 className="font-bold text-xl my-8 mx-3">Transaction ID : {transactionData[0]?.id}</h1>
              <section className="flex justify-between items-start">
                <section className="p-6 shadow-sm w-[30vw] bg-white">
                  ...
                  <ul className="p-5 flex flex-col gap-7 text-sm font-light">
                    ...
                    <li className="flex items-center gap-3">
                      ...
                      <a
                        ...
                        rel="noreferrer"
                      >
                        <IoDocumentAttachOutline className="text-3xl hover:scale-105 cursor-pointer" />
                      </a>
                    </li>
                  </ul>
                </section>

                <section className="p-5 shadow-sm w-[18vw] bg-white">
...

              {
                ...
                <h2 className="text-lg font-semibold"> You have not confirmed the Transaction yet!</h2>
                <button className="border border-green-500 transition-all hover:bg-green-500 hover:text-white p-2 text-xs rounded-md"
